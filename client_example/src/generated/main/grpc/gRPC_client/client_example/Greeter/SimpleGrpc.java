package gRPC_client.client_example.Greeter;
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<gRPC_client.client_example.Greeter.HelloRequest,
      gRPC_client.client_example.Greeter.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = gRPC_client.client_example.Greeter.HelloRequest.class,
      responseType = gRPC_client.client_example.Greeter.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<gRPC_client.client_example.Greeter.HelloRequest,
      gRPC_client.client_example.Greeter.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<gRPC_client.client_example.Greeter.HelloRequest, gRPC_client.client_example.Greeter.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<gRPC_client.client_example.Greeter.HelloRequest, gRPC_client.client_example.Greeter.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gRPC_client.client_example.Greeter.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gRPC_client.client_example.Greeter.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(gRPC_client.client_example.Greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<gRPC_client.client_example.Greeter.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                gRPC_client.client_example.Greeter.HelloRequest,
                gRPC_client.client_example.Greeter.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
    ...
    /**
     */
    public gRPC_client.client_example.Greeter.HelloReply sayHello(gRPC_client.client_example.Greeter.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<gRPC_client.client_example.Greeter.HelloReply> sayHello(
        gRPC_client.client_example.Greeter.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((gRPC_client.client_example.Greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<gRPC_client.client_example.Greeter.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return gRPC_client.client_example.Greeter.HelloWorldProto.getDescriptor();
    }
